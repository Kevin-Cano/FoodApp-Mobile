  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <View
          className="flex-row justify-between items-center px-6 pt-4 mb-8"
          style={{
            flexDirection: 'row',
        ...
        >
          ...
          >
            ...
            <View>
              <Text
                className="text-[#888888] text-[13px] mb-0.5"
                style={{ color: '#888888', fontSize: 13, marginBottom: 2 }}
              >
                Deliver to
              </Text>
              <Text
          ...
          >
            <TouchableOpacity className="relative" style={{ position: 'relative' }}>
              ...
              <View
                className="absolute top-0 right-0 w-2.5 h-2.5 bg-[#EC994B] rounded-full border-2 border-white"
                style={{
                  position: 'absolute',
                  top: 0,
                  right: 0,
        ...
        {/* Title */}
        <Text
          className="text-[28px] font-extrabold text-[#333333] leading-[36px] px-6 mb-8 w-[80%]"
          style={{
            fontSize: 28,
            fontWeight: '800',
            color: '#333333',
        ...
        {loading ? (
          ...
          <>
            ...
            <View className="mb-8" style={{ marginBottom: 32 }}>
              <View
                className="flex-row justify-between items-end px-6 mb-4"
                style={{
                  flexDirection: 'row',
                  justifyContent: 'space-between',
                  alignItems: 'flex-end',
              ...
              >
                <View>
                  <Text
                    className="text-[#333333] text-[20px] font-bold mb-1"
                    style={{ color: '#333333', fontSize: 20, fontWeight: 'bold', marginBottom: 4 }}
                  >
                    Popular
                  </Text>
                  <Text
                ...
                <TouchableOpacity>
                  <Text
                    className="text-[#EC994B] text-[14px] font-bold"
                    style={{ color: '#EC994B', fontSize: 14, fontWeight: 'bold' }}
                  >
                    See All
                  </Text>
                </TouchableOpacity>
              ...
              >
                {popularMeals.map((meal) => (
                  <DishCard
                    ...
                    price={meal.price}
                    onPress={() => router.push(`/food/${meal.id}` as any)}
                  />
                ))}
              </ScrollView>
            </View>
